...
3. New examples
    ...
    * [dpapidump.py](examples/dpapidump.py) dumps DPAPI-related secrets. (#1917)
    * [checkMSSQLStatus.py](examples/checkMSSQLStatus.py) checks MSSQL status and CBT behavior. (#2098)

4. Project & packaging

    * Removed the run-time dependency on setuptools. (#2102)
    * Removed remaining Python 2 compatibility code from WMI and ESE modules. (#1804)
